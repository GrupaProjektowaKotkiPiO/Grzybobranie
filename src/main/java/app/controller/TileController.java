...
public class TileController {
    ...
    public TileController() {
        ...
        board[1]=new Tile(TileType.NORMAL,182, 129);
        board[2]=new Tile(TileType.NORMAL,86, 213);
        board[3]=new Tile(TileType.NORMAL,186, 259);
        board[4]=new Tile(TileType.RABBIT,288, 257);
        board[5]=new Tile(TileType.NORMAL,404, 244);
        board[6]=new Tile(TileType.NORMAL,360, 158);
        board[7]=new Tile(TileType.NORMAL,288, 85 );
        board[8]=new Tile(TileType.NORMAL,418, 72 );
        board[9]=new Tile(TileType.NORMAL,512, 129);
        board[10]=new Tile(TileType.NORMAL,555, 231);
        board[11]=new Tile(TileType.MOUNTAIN,613, 157);
        board[12]=new Tile(TileType.NORMAL,684, 86 );
        board[13]=new Tile(TileType.NORMAL,744, 172);
        board[14]=new Tile(TileType.NORMAL,744, 275);
        ...
        board[23]=new Tile(TileType.NORMAL,173, 725);
        ...
        board[30]=new Tile(TileType.BOAR,393, 471);
        board[31]=new Tile(TileType.NORMAL,516, 471);
